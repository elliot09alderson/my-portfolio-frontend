...
export default function Home({ blogs, profile, project, experience, skills }) {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <link rel="icon" type="image/png" href="/assets/img/mylogo.png" />
              ...
              <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                ...
                <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                  ...
                  <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                    ...
                    <a href={profile.insta} className="pl-4">
                  ...
                  <div className="buttons text-center md:text-left sm:text-center pt-4">
                <Link href={"/blogs"}>
                    <buttton className="bg-purple-600 text-white border-2 py-1 my-4 px-4 rounded-2xl">
                      All Blogs
                    </buttton>
                </Link>
                  </div>
          ...
          <div className="grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
            <div className="group rounded px-8 py-12 shadow hover:bg-primary">
              ...
              <div className="text-center">
                ...
                <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                  Having many Project Experienced using Fully optimised Full
                  stack Web App Development using MERN and Next js as well as
                  Sanity CMS.
                </p>
              </div>
            </div>
            ...
            <div className="group rounded px-8 py-12 shadow hover:bg-primary">
              ...
              <div className="text-center">
                ...
                <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                  Using canva i have generated my skill-sets like product
                  designing as well as graphic template design & content
                  designing
                </p>
              </div>
            </div>
            <div className="group rounded px-8 py-12 shadow hover:bg-primary">
              ...
              <div className="text-center">
                ...
                <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                  I am Experienced in latest technologies like Saas or post css
                  And Heavyily optimized SEO friendly framework like NextJs-13
                </p>
              </div>
            </div>
          </div>
            ...
            {project.map((proj) => {
              return (
                ...
                >
                  <img
                    key={proj.alt}
                    src={builder.image(proj.image).url()}
                  ...
                  <div className="md:w-2/5">
                    <div className="flex justify-center md:justify-start">
                      <span className="shrink-0">
                        <img
                          src={builder.image(element.image).url()}
        ...
        <div className="container py-16 md:py-20" id="contact">
          ...
          <div className="mx-auto w-full pt-5 text-center sm:w-2/3 lg:pt-6">
            <p className="font-body text-grey-10">
              Here You can ask or offer me any thing
            </p>
          </div>
      ...
      <div className="bg-primary">
        <div className="container flex flex-col justify-between py-6 sm:flex-row">
          <p className="text-center font-body text-white md:text-left">
            © Copyright 2023. All right reserved, WorkWithPratik.
          </p>
